...
public class VisionController {
    ...
    public StoryResponse storyFromFile(
            ...
            @RequestParam(value = "scene", defaultValue = "food") String scene) throws Exception {
        return visionStoryService.generateFromImage(file, scene);
    }
    ...
    public StoryResponse storyFromJson(@RequestBody Map<String, String> body) {
        ...
        String scene = body.getOrDefault("scene", "food");
        return visionStoryService.generateFromBase64(imageBase64, scene);
    }
}
